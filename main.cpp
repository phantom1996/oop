...
//	play(1);
	...
	gotoxy(56,23);cout<<"Sharad Nailwal    2k17/IT/110";
	gotoxy(56,24);cout<<"THIS IS MY FIRST OOPS PROJECT.HOPES U LIKE IT.THANK YOU";
	Sleep(2000);
...
void machine::help()		//initial help notice in mainmenu on opening account
{
	...
	gotoxy(3,22);
	cout<<"For more information, contact: Branch Manager xxxxxx";
	gotoxy(3,23);
	cout<<"Call our 24x7 helpline through toll free 1800 100 2400.";
	gotoxy(3,24);
	cout<<"Contact at Sharad.blogspot.in";
